...
import { addProductToCart, deleteProductsFromCart, removeProductsFromCart } from '../../../redux/reducers/cartReducer/actionCreator';
      ...
      <tr key={id}>
          <td>
              <div className="card card--corbage" style={{ marginLeft: "0px" }}>
                  <span className="card__delete-icon"
                  ...
                  <div className="card__body">
                      <h5 className="card__title card__title--cart">
                        <Link to={`/shop/${category}/${id}`} style={{color:"inherit"}}>{name}</Link>
                      </h5>
                  </div>
              </div>
          </td>
