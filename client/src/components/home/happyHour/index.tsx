        ...
        <section className="happy-hour">
            <div className="container">
                <div className="happy-hour__content">
                    ...
                    <div className="happy-hour__item">
                        <p className="happy-hour__text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, sit provident tempore commodi ab qui accusantium minima</p>
